...
void ofApp::setup()
{
    ...
    r = chuck->compileFile( "ck/band.ck" );
	//r = chuck->compileFile( "ck/gametrax_demo.ck" );
...
//    OFCKDB::instance()->loadImage("texture:flare-3", "flare-tng-3.png");
    OFCKDB::instance()->loadImage("floorTex", "flare-tng-4.png");
//    OFCKDB::instance()->loadImage("texture:flare-5", "flare-tng-5.png");

    OFCKDB::instance()->loadImage("naryu", "Naryu.png");
    OFCKDB::instance()->loadImage("farore", "Farore.png");
    OFCKDB::instance()->loadImage("din", "Din.png");
    OFCKDB::instance()->loadImage("note", "note.png");
    OFCKDB::instance()->loadImage("noteRing", "note_ring.png");
...
void ofApp::drawScene()
{
    ...
    // set position
//    m_camera.setPosition( ofVec3f(0,oculusRift.getUserEyeHeight(),0) );
	m_camera.setPosition( ofVec3f(0,3,0) );
    // look at
    //m_camera.lookAt( ofVec3f(0,oculusRift.getUserEyeHeight(),5), ofVec3f(0,1,0) );
    m_camera.lookAt( ofVec3f(0,3,5), ofVec3f(0,1,0) );
